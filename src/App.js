  ...
  return (
   <>
    ...
    {/* <Router> */}
      ...
      <Alert alert = {alert} />
      <TextForm mode={mode} alert={showAlert} heading={'Try MY Textutils - Word Counter, Character counter, Uppercase to Lowercase, Lowercase to Uppercase, Extra Space Remover'} />
      {/* <Routes>
